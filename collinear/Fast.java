    ...
    private static void putLines(Point[] points, int start, int end) {
        ...
        for (int i = start + 1; i < end; i++) {
            ...
            if (!equals || i == end -1) {
                ...
                // Т.к. наклоны текущей и предыдущей точки не равны,
                // то считаем текущую первой равной, и сбрасываем счётчик равных.
                // Естественно, если мы сюда попали на последней точке, то эти
                // переменные уже никому не будут нужны. Ну и чёрт с ними.
                firstEqual = i;
                equal = 1;
            }
        }
